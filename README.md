...
- [Introduction](#introduction)
    - [Guidelines of the assignment](#guidelines-of-the-assignment)
- [My Project](#chuckstuff-chuck-norris-facts-made-possible-via-terraform-ansible-and-docker)
    - [Setup](#setup)
    - [Test Locally](#test-locally)
    - [Clean up, Chuck!](#clean-up-chuck)
    - [TODO](#todo)
...
## TODO
[ ] split singular ansible playbook into roles

[ ] split singular terrafrom file into modules

[ ] improve ansible automation for error handling & idempotency

[ ] add terraform support for other cloud providers
